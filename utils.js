...
// export function getGroups(regex) {
...
//     while(true) {
//         if(i > 10) break;
//         if(!string.match(regex)) break;
//         const m = string.match(regex);
//         const s = string.slice(0, m.index + 1);
//         groups.push(s);
//         string = string.slice(m.index + 1);
//         i++;
//     }
//     return groups.flat(Infinity);
// }

// String.prototype.getGroups = getGroups;

// console.log("hello, world".getGroups("l"));
...
import { random, chance, getEl, wait, isTrue, isFalse, safeEval, RandomNums, ClickRegion, copyToClipboard, dist, mouse, lsGet, lsSet } from '/functionpack.js';
*/
